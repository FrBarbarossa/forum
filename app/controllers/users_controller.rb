...
# Controller for users & auth
class UsersController < ApplicationController
  before_action :logged_only, only: %i[lks logout avatar description name modal]
  before_action :unlogged_only, only: %i[login register signin create]
  def create; end
